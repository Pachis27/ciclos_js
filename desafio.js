...
function fizzBuzz(numero) {
  ...
  return numero % 15 === 0 ? "fizzbuzz" : numero % 5 === 0 ? "buzz" : numero % 3 === 0 ? "fizz" : numero ;
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  return  num1 === 0 || num2 === 0 || num3 === 0 ? "Error": num1 < 0 || num2 < 0 || num3 < 0 ? "Hay negativos" : num1 > num2 && num1 > num3 && num1 > 0 ? "Numero 1 es mayor y positivo": num3 > num1 && num3 > num2 ? num3 + 1 : "False" ;
}
